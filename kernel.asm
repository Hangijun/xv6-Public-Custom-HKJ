...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 e7 76 10 80 	movl   $0x801076e7,(%esp)
...
801007c8:	e8 33 3d 00 00       	call   80104500 <acquire>
...
80100803:	e8 f8 3c 00 00       	call   80104500 <acquire>
  while((c = getc()) >= 0){
...
80100c2d:	e8 0e 3c 00 00       	call   80104840 <strlen>
...
80100c40:	e8 fb 3b 00 00       	call   80104840 <strlen>
...
80100d00:	e8 fb 3a 00 00       	call   80104800 <safestrcpy>
...
80100d60:	e8 3b 36 00 00       	call   801043a0 <initlock>
}
...
80100d81:	e8 7a 37 00 00       	call   80104500 <acquire>
...
80100db1:	e8 fa 37 00 00       	call   801045b0 <release>
      return f;
...
80100dc8:	e8 e3 37 00 00       	call   801045b0 <release>
  return 0;
...
80100def:	e8 0c 37 00 00       	call   80104500 <acquire>
  if(f->ref < 1)
...
80100e0c:	e8 9f 37 00 00       	call   801045b0 <release>
  return f;
}
...
80100e41:	e8 ba 36 00 00       	call   80104500 <acquire>
  if(f->ref < 1)
...
80100e6b:	5d                   	pop    %ebp
  ...
  if(--f->ref > 0){
    release(&ftable.lock);
80100e6c:	e9 3f 37 00 00       	jmp    801045b0 <release>
...
80100e95:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e98:	e8 13 37 00 00       	call   801045b0 <release>
...
80101165:	68 7f 71 10 80       	push   $0x8010717f
...
80101212:	68 92 71 10 80       	push   $0x80107192
...
80101255:	e8 a6 33 00 00       	call   80104600 <memset>
  log_write(bp);
...
8010129a:	e8 61 32 00 00       	call   80104500 <acquire>
...
801012df:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012e2:	e8 c9 32 00 00       	call   801045b0 <release>
      return ip;
...
8010132f:	e8 7c 32 00 00       	call   801045b0 <release>
...
80101344:	68 a8 71 10 80       	push   $0x801071a8
...
8010140a:	68 b8 71 10 80       	push   $0x801071b8
...
80101441:	e8 6a 32 00 00       	call   801046b0 <memmove>
  brelse(bp);
...
8010146c:	68 cb 71 10 80       	push   $0x801071cb
...
80101483:	68 d2 71 10 80       	push   $0x801071d2
80101488:	53                   	push   %ebx
80101489:	81 c3 90 00 00 00    	add    $0x90,%ebx
8010148f:	e8 dc 2d 00 00       	call   80104270 <initsleeplock>
iinit(int dev)
{
  int i = 0;
...
801014d9:	68 38 72 10 80       	push   $0x80107238
...
801015a3:	68 d8 71 10 80       	push   $0x801071d8
...
8010163f:	e8 bc 2e 00 00       	call   80104500 <acquire>
  ip->ref++;
...
80101682:	e8 29 2c 00 00       	call   801042b0 <acquiresleep>
...
8010171d:	68 f0 71 10 80       	push   $0x801071f0
...
8010172a:	68 ea 71 10 80       	push   $0x801071ea
...
80101753:	e8 f8 2b 00 00       	call   80104350 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
8010176f:	e9 9c 2b 00 00       	jmp    80104310 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
80101777:	68 ff 71 10 80       	push   $0x801071ff
...
801017a0:	e8 0b 2b 00 00       	call   801042b0 <acquiresleep>
...
801017ba:	e8 51 2b 00 00       	call   80104310 <releasesleep>

  acquire(&icache.lock);
801017bf:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017c6:	e8 35 2d 00 00       	call   80104500 <acquire>
  ip->ref--;
...
801017f0:	e8 0b 2d 00 00       	call   80104500 <acquire>
    int r = ip->ref;
...
80101c1d:	68 19 72 10 80       	push   $0x80107219
...
80101c2a:	68 07 72 10 80       	push   $0x80107207
...
80101c69:	e8 92 28 00 00       	call   80104500 <acquire>
  ip->ref++;
...
80101cd5:	e8 d6 29 00 00       	call   801046b0 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101d64:	e8 47 29 00 00       	call   801046b0 <memmove>
    name[len] = 0;
...
80101e4d:	e8 4e 29 00 00       	call   801047a0 <strncpy>
  de.inum = inum;
...
80101e8b:	68 28 72 10 80       	push   $0x80107228
...
80101e98:	68 42 79 10 80       	push   $0x80107942
...
80101fa0:	68 94 72 10 80       	push   $0x80107294
...
80101fad:	68 8b 72 10 80       	push   $0x8010728b
...
80101fc6:	68 a6 72 10 80       	push   $0x801072a6
80101fcb:	68 80 a5 10 80       	push   $0x8010a580
80101fd0:	e8 cb 23 00 00       	call   801043a0 <initlock>
...
8010204e:	e8 ad 24 00 00       	call   80104500 <acquire>
...
8010209c:	e8 0f 25 00 00       	call   801045b0 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801020ee:	e8 5d 22 00 00       	call   80104350 <holdingsleep>
...
80102128:	e8 d3 23 00 00       	call   80104500 <acquire>
...
80102195:	c9                   	leave  
  ...
  release(&idelock);
80102196:	e9 15 24 00 00       	jmp    801045b0 <release>
...
801021ae:	68 aa 72 10 80       	push   $0x801072aa
...
801021bb:	68 d5 72 10 80       	push   $0x801072d5
...
801021c8:	68 c0 72 10 80       	push   $0x801072c0
...
80102348:	e8 b3 21 00 00       	call   80104500 <acquire>
...
80102355:	68 26 73 10 80       	push   $0x80107326
...
801023bb:	68 2c 73 10 80       	push   $0x8010732c
...
801024c8:	e8 33 20 00 00       	call   80104500 <acquire>
  r = kmem.freelist;
...
80102526:	0f b6 82 60 74 10 80 	movzbl -0x7fef8ba0(%edx),%eax
...
8010254e:	0f b6 82 60 74 10 80 	movzbl -0x7fef8ba0(%edx),%eax
80102555:	09 c1                	or     %eax,%ecx
80102557:	0f b6 82 60 73 10 80 	movzbl -0x7fef8ca0(%edx),%eax
...
8010256b:	83 e1 08             	and    $0x8,%ecx
  ...
  shift ^= togglecode[data];
  c = charcode[shift & (CTL | SHIFT)][data];
8010256e:	8b 04 85 40 73 10 80 	mov    -0x7fef8cc0(,%eax,4),%eax
...
801028d4:	e8 77 1d 00 00       	call   80104650 <memcmp>
...
80102a04:	e8 a7 1c 00 00       	call   801046b0 <memmove>
...
80102aaa:	68 60 75 10 80       	push   $0x80107560
80102aaf:	68 80 26 11 80       	push   $0x80112680
80102ab4:	e8 e7 18 00 00       	call   801043a0 <initlock>
  readsb(dev, &sb);
80102ab9:	58                   	pop    %eax
...
80102b4b:	e8 b0 19 00 00       	call   80104500 <acquire>
...
80102b9c:	e8 0f 1a 00 00       	call   801045b0 <release>
      break;
    }
  }
}
...
80102bbe:	e8 3d 19 00 00       	call   80104500 <acquire>
  log.outstanding -= 1;
...
80102bfd:	e8 ae 19 00 00       	call   801045b0 <release>
}
...
80102c5c:	e8 4f 1a 00 00       	call   801046b0 <memmove>
...
80102ca5:	e8 56 18 00 00       	call   80104500 <acquire>
    log.committing = 0;
    wakeup(&log);
...
80102cc7:	e8 e4 18 00 00       	call   801045b0 <release>
...
80102cf4:	e8 b7 18 00 00       	call   801045b0 <release>
...
80102d07:	68 64 75 10 80       	push   $0x80107564
...
80102d5e:	e8 9d 17 00 00       	call   80104500 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dad:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102dae:	e9 fd 17 00 00       	jmp    801045b0 <release>
80102db3:	90                   	nop
...
80102dd3:	68 73 75 10 80       	push   $0x80107573
80102dd8:	e8 93 d5 ff ff       	call   80100370 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102ddd:	83 ec 0c             	sub    $0xc,%esp
80102de0:	68 89 75 10 80       	push   $0x80107589
...
80102e08:	68 a4 75 10 80       	push   $0x801075a4
80102e0d:	e8 4e d8 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e12:	e8 b9 2a 00 00       	call   801058d0 <idtinit>
...
80102e33:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e36:	e8 b5 3b 00 00       	call   801069f0 <switchkvm>
  seginit();
80102e3b:	e8 b0 3a 00 00       	call   801068f0 <seginit>
  lapicinit();
...
80102e99:	e8 22 2d 00 00       	call   80105bc0 <uartinit>
  pinit();         // process table
80102e9e:	e8 0d 08 00 00       	call   801036b0 <pinit>
  tvinit();        // trap vectors
80102ea3:	e8 88 29 00 00       	call   80105830 <tvinit>
  binit();         // buffer cache
...
80102ec9:	e8 e2 17 00 00       	call   801046b0 <memmove>
...
80102f98:	68 b8 75 10 80       	push   $0x801075b8
80102f9d:	56                   	push   %esi
80102f9e:	e8 ad 16 00 00       	call   80104650 <memcmp>
...
8010305c:	68 bd 75 10 80       	push   $0x801075bd
80103061:	56                   	push   %esi
80103062:	e8 e9 15 00 00       	call   80104650 <memcmp>
...
801030f0:	ff 24 95 fc 75 10 80 	jmp    *-0x7fef8a04(,%edx,4)
...
80103197:	68 c2 75 10 80       	push   $0x801075c2
...
801031a4:	68 dc 75 10 80       	push   $0x801075dc
...
80103250:	00 00 00 
  initlock(&p->lock, "pipe");
80103253:	68 10 76 10 80       	push   $0x80107610
80103258:	50                   	push   %eax
80103259:	e8 42 11 00 00       	call   801043a0 <initlock>
  (*f0)->type = FD_PIPE;
...
801032ef:	e8 0c 12 00 00       	call   80104500 <acquire>
  if(writable){
...
80103333:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103334:	e9 77 12 00 00       	jmp    801045b0 <release>
...
80103364:	e8 47 12 00 00       	call   801045b0 <release>
    kfree((char*)p);
...
8010338d:	e8 6e 11 00 00       	call   80104500 <acquire>
  for(i = 0; i < n; i++){
...
80103414:	e8 97 11 00 00       	call   801045b0 <release>
        return -1;
...
8010346b:	e8 40 11 00 00       	call   801045b0 <release>
  return n;
...
80103490:	e8 6b 10 00 00       	call   80104500 <acquire>
...
801034f9:	e8 b2 10 00 00       	call   801045b0 <release>
      return -1;
...
80103566:	e8 45 10 00 00       	call   801045b0 <release>
  return i;
...
801035b1:	e8 4a 0f 00 00       	call   80104500 <acquire>
...
801035ec:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
801035f2:	e8 b9 0f 00 00       	call   801045b0 <release>
...
80103614:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103617:	c7 40 14 21 58 10 80 	movl   $0x80105821,0x14(%eax)
...
80103623:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103626:	e8 d5 0f 00 00       	call   80104600 <memset>
...
80103648:	e8 63 0f 00 00       	call   801045b0 <release>
  return 0;
...
8010366b:	e8 40 0f 00 00       	call   801045b0 <release>
...
801036b6:	68 15 76 10 80       	push   $0x80107615
801036bb:	68 20 2d 11 80       	push   $0x80112d20
801036c0:	e8 db 0c 00 00       	call   801043a0 <initlock>
}
...
8010372d:	68 1c 76 10 80       	push   $0x8010761c
...
8010373a:	68 14 78 10 80       	push   $0x80107814
...
80103774:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103777:	e8 a4 0c 00 00       	call   80104420 <pushcli>
  c = mycpu();
8010377c:	e8 4f ff ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103781:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103787:	e8 d4 0c 00 00       	call   80104460 <popcli>
  return p;
}
...
801037b3:	e8 58 36 00 00       	call   80106e10 <setupkvm>
...
801037d1:	e8 4a 33 00 00       	call   80106b20 <inituvm>
  p->sz = PGSIZE;
...
801037e6:	e8 15 0e 00 00       	call   80104600 <memset>
...
8010383f:	68 45 76 10 80       	push   $0x80107645
80103844:	50                   	push   %eax
80103845:	e8 b6 0f 00 00       	call   80104800 <safestrcpy>
  p->cwd = namei("/");
8010384a:	c7 04 24 4e 76 10 80 	movl   $0x8010764e,(%esp)
...
80103860:	e8 9b 0c 00 00       	call   80104500 <acquire>
...
80103873:	e8 38 0d 00 00       	call   801045b0 <release>
}
...
80103883:	68 2c 76 10 80       	push   $0x8010762c
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103898:	e8 83 0b 00 00       	call   80104420 <pushcli>
  c = mycpu();
8010389d:	e8 2e fe ff ff       	call   801036d0 <mycpu>
  p = c->proc;
801038a2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038a8:	e8 b3 0b 00 00       	call   80104460 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
801038be:	e8 9d 33 00 00       	call   80106c60 <allocuvm>
...
801038d0:	e8 3b 31 00 00       	call   80106a10 <switchuvm>
  return 0;
...
801038f4:	e8 67 34 00 00       	call   80106d60 <deallocuvm>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103919:	e8 02 0b 00 00       	call   80104420 <pushcli>
  c = mycpu();
8010391e:	e8 ad fd ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103923:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103929:	e8 32 0b 00 00       	call   80104460 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
80103948:	e8 93 35 00 00       	call   80106ee0 <copyuvm>
...
801039c1:	e8 3a 0e 00 00       	call   80104800 <safestrcpy>
...
801039d0:	e8 2b 0b 00 00       	call   80104500 <acquire>
...
801039e3:	e8 c8 0b 00 00       	call   801045b0 <release>
...
80103a5e:	e8 9d 0a 00 00       	call   80104500 <acquire>
...
80103a8b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a8e:	e8 7d 2f 00 00       	call   80106a10 <switchuvm>
      p->state = RUNNING;
...
80103a99:	c7 43 90 04 00 00 00 	movl   $0x4,-0x70(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103aa0:	e8 b6 0d 00 00       	call   8010485b <swtch>
      switchkvm();
80103aa5:	e8 46 2f 00 00       	call   801069f0 <switchkvm>
...
80103ac8:	e8 e3 0a 00 00       	call   801045b0 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ae5:	e8 36 09 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103aea:	e8 e1 fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103aef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103af5:	e8 66 09 00 00       	call   80104460 <popcli>
sched(void)
{
  int intena;
...
80103b02:	e8 c9 09 00 00       	call   801044d0 <holding>
...
80103b43:	e8 13 0d 00 00       	call   8010485b <swtch>
  mycpu()->intena = intena;
...
80103b60:	68 50 76 10 80       	push   $0x80107650
...
80103b6d:	68 7c 76 10 80       	push   $0x8010767c
...
80103b7a:	68 6e 76 10 80       	push   $0x8010766e
...
80103b87:	68 62 76 10 80       	push   $0x80107662
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ba9:	e8 72 08 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103bae:	e8 1d fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103bb3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bb9:	e8 a2 08 00 00       	call   80104460 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103c12:	e8 e9 08 00 00       	call   80104500 <acquire>
...
80103cad:	68 9d 76 10 80       	push   $0x8010769d
...
80103cba:	68 90 76 10 80       	push   $0x80107690
...
80103cdc:	e8 1f 08 00 00       	call   80104500 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103ce1:	e8 3a 07 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103ce6:	e8 e5 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103ceb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cf1:	e8 6a 07 00 00       	call   80104460 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103d09:	e8 a2 08 00 00       	call   801045b0 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d2f:	e8 ec 06 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103d34:	e8 97 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103d39:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d3f:	e8 1c 07 00 00       	call   80104460 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103d60:	e8 9b 07 00 00       	call   80104500 <acquire>
    release(lk);
80103d65:	89 34 24             	mov    %esi,(%esp)
80103d68:	e8 43 08 00 00       	call   801045b0 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d8a:	e8 21 08 00 00       	call   801045b0 <release>
    acquire(lk);
...
80103d9b:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103d9c:	e9 5f 07 00 00       	jmp    80104500 <acquire>
...
80103dc9:	68 af 76 10 80       	push   $0x801076af
...
80103dd6:	68 a9 76 10 80       	push   $0x801076a9
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103de5:	e8 36 06 00 00       	call   80104420 <pushcli>
  c = mycpu();
80103dea:	e8 e1 f8 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103def:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103df5:	e8 66 06 00 00       	call   80104460 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103e02:	e8 f9 06 00 00       	call   80104500 <acquire>
...
80103e70:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e77:	e8 14 2f 00 00       	call   80106d90 <freevm>
        p->pid = 0;
...
80103ea3:	e8 08 07 00 00       	call   801045b0 <release>
        return pid;
...
80103ebc:	e8 ef 06 00 00       	call   801045b0 <release>
      return -1;
...
80103edf:	e8 1c 06 00 00       	call   80104500 <acquire>
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f21:	e9 8a 06 00 00       	jmp    801045b0 <release>
...
80103f74:	e8 37 06 00 00       	call   801045b0 <release>
      return 0;
...
80103fa0:	e8 0b 06 00 00       	call   801045b0 <release>
  return -1;
...
80103fdb:	68 e7 76 10 80       	push   $0x801076e7
...
80103ffe:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80104001:	ba c0 76 10 80       	mov    $0x801076c0,%edx
  uint pc[10];
...
80104008:	8b 14 85 3c 78 10 80 	mov    -0x7fef87c4(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
8010400f:	b8 c0 76 10 80       	mov    $0x801076c0,%eax
...
8010401e:	68 c4 76 10 80       	push   $0x801076c4
...
80104045:	e8 76 03 00 00       	call   801043c0 <getcallerpcs>
...
8010405d:	68 01 71 10 80       	push   $0x80107101
...
8010408d:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
80104092:	e8 69 04 00 00       	call   80104500 <acquire>
  cprintf("name \t pid \t ppid \t state \n");
80104097:	c7 04 24 cd 76 10 80 	movl   $0x801076cd,(%esp)
8010409e:	e8 bd c5 ff ff       	call   80100660 <cprintf>
801040a3:	83 c4 10             	add    $0x10,%esp
801040a6:	eb 33                	jmp    801040db <cps+0x5b>
801040a8:	90                   	nop
...
801040b0:	83 f8 04             	cmp    $0x4,%eax
801040b3:	74 73                	je     80104128 <cps+0xa8>
      else
      {
...
801040b8:	0f 84 92 00 00 00    	je     80104150 <cps+0xd0>
      {
...
801040be:	83 f8 01             	cmp    $0x1,%eax
801040c1:	0f 84 b1 00 00 00    	je     80104178 <cps+0xf8>
      {
...
801040ca:	0f 84 d0 00 00 00    	je     801041a0 <cps+0x120>
801040d0:	83 c3 7c             	add    $0x7c,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040d3:	81 fb c0 4c 11 80    	cmp    $0x80114cc0,%ebx
801040d9:	74 32                	je     8010410d <cps+0x8d>
  {
    if(p->state == SLEEPING)
801040db:	8b 43 a0             	mov    -0x60(%ebx),%eax
801040de:	83 f8 02             	cmp    $0x2,%eax
801040e1:	75 cd                	jne    801040b0 <cps+0x30>
    {
      if(p->parent == 0)
801040e3:	8b 43 a8             	mov    -0x58(%ebx),%eax
801040e6:	85 c0                	test   %eax,%eax
801040e8:	0f 84 da 00 00 00    	je     801041c8 <cps+0x148>
      ...
      {
        cprintf("%s \t %d \t %d \t SLEEPING \n ", p->name, p->pid, p->parent->pid);
801040ee:	ff 70 10             	pushl  0x10(%eax)
801040f1:	ff 73 a4             	pushl  -0x5c(%ebx)
801040f4:	53                   	push   %ebx
801040f5:	68 03 77 10 80       	push   $0x80107703
801040fa:	83 c3 7c             	add    $0x7c,%ebx
...
80104102:	83 c4 10             	add    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104105:	81 fb c0 4c 11 80    	cmp    $0x80114cc0,%ebx
8010410b:	75 ce                	jne    801040db <cps+0x5b>
...
80104115:	e8 96 04 00 00       	call   801045b0 <release>
  return 22;
8010411a:	b8 16 00 00 00       	mov    $0x16,%eax
8010411f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104122:	c9                   	leave  
80104123:	c3                   	ret    
80104124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    {
      if(p->parent == 0)
80104128:	8b 43 a8             	mov    -0x58(%ebx),%eax
8010412b:	85 c0                	test   %eax,%eax
8010412d:	0f 84 b5 00 00 00    	je     801041e8 <cps+0x168>
        cprintf("%s \t %d \t - \t RUNNING \n ", p->name, p->pid);
      }
      ...
      {
        cprintf("%s \t %d \t %d \t RUNNING \n ", p->name, p->pid, p->parent->pid);
80104133:	ff 70 10             	pushl  0x10(%eax)
80104136:	ff 73 a4             	pushl  -0x5c(%ebx)
80104139:	53                   	push   %ebx
8010413a:	68 37 77 10 80       	push   $0x80107737
8010413f:	e8 1c c5 ff ff       	call   80100660 <cprintf>
80104144:	83 c4 10             	add    $0x10,%esp
80104147:	eb 87                	jmp    801040d0 <cps+0x50>
80104149:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    {
      if(p->parent == 0)
80104150:	8b 43 a8             	mov    -0x58(%ebx),%eax
80104153:	85 c0                	test   %eax,%eax
80104155:	0f 84 ad 00 00 00    	je     80104208 <cps+0x188>
      ...
      {
        cprintf("%s \t %d \t %d \t RUNNABLE \n ", p->name, p->pid, p->parent->pid);
8010415b:	ff 70 10             	pushl  0x10(%eax)
8010415e:	ff 73 a4             	pushl  -0x5c(%ebx)
80104161:	53                   	push   %ebx
80104162:	68 6b 77 10 80       	push   $0x8010776b
80104167:	e8 f4 c4 ff ff       	call   80100660 <cprintf>
8010416c:	83 c4 10             	add    $0x10,%esp
8010416f:	e9 5c ff ff ff       	jmp    801040d0 <cps+0x50>
80104174:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    {
      if(p->parent == 0)
80104178:	8b 43 a8             	mov    -0x58(%ebx),%eax
8010417b:	85 c0                	test   %eax,%eax
8010417d:	0f 84 a5 00 00 00    	je     80104228 <cps+0x1a8>
        cprintf("%s \t %d \t - \t EMBRYO \n ", p->name, p->pid);
      }
      ...
      {
        cprintf("%s \t %d \t %d \t EMBRYO \n ", p->name, p->pid, p->parent->pid);
80104183:	ff 70 10             	pushl  0x10(%eax)
80104186:	ff 73 a4             	pushl  -0x5c(%ebx)
80104189:	53                   	push   %ebx
8010418a:	68 9e 77 10 80       	push   $0x8010779e
8010418f:	e8 cc c4 ff ff       	call   80100660 <cprintf>
80104194:	83 c4 10             	add    $0x10,%esp
80104197:	e9 34 ff ff ff       	jmp    801040d0 <cps+0x50>
8010419c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    {
      if(p->parent == 0)
801041a0:	8b 43 a8             	mov    -0x58(%ebx),%eax
801041a3:	85 c0                	test   %eax,%eax
801041a5:	0f 84 9d 00 00 00    	je     80104248 <cps+0x1c8>
        cprintf("%s \t %d \t - \t ZOMBIE \n ", p->name, p->pid);
      }
      ...
      {
        cprintf("%s \t %d \t %d \t ZOMBIE \n ", p->name, p->pid, p->parent->pid);
801041ab:	ff 70 10             	pushl  0x10(%eax)
801041ae:	ff 73 a4             	pushl  -0x5c(%ebx)
801041b1:	53                   	push   %ebx
801041b2:	68 cf 77 10 80       	push   $0x801077cf
801041b7:	e8 a4 c4 ff ff       	call   80100660 <cprintf>
801041bc:	83 c4 10             	add    $0x10,%esp
801041bf:	e9 0c ff ff ff       	jmp    801040d0 <cps+0x50>
...
801041cf:	68 e9 76 10 80       	push   $0x801076e9
801041d4:	e8 87 c4 ff ff       	call   80100660 <cprintf>
801041d9:	83 c4 10             	add    $0x10,%esp
801041dc:	e9 ef fe ff ff       	jmp    801040d0 <cps+0x50>
...
801041ef:	68 1e 77 10 80       	push   $0x8010771e
801041f4:	e8 67 c4 ff ff       	call   80100660 <cprintf>
801041f9:	83 c4 10             	add    $0x10,%esp
801041fc:	e9 cf fe ff ff       	jmp    801040d0 <cps+0x50>
...
8010420f:	68 51 77 10 80       	push   $0x80107751
80104214:	e8 47 c4 ff ff       	call   80100660 <cprintf>
80104219:	83 c4 10             	add    $0x10,%esp
8010421c:	e9 af fe ff ff       	jmp    801040d0 <cps+0x50>
...
8010422f:	68 86 77 10 80       	push   $0x80107786
80104234:	e8 27 c4 ff ff       	call   80100660 <cprintf>
80104239:	83 c4 10             	add    $0x10,%esp
8010423c:	e9 8f fe ff ff       	jmp    801040d0 <cps+0x50>
...
8010424f:	68 b7 77 10 80       	push   $0x801077b7
80104254:	e8 07 c4 ff ff       	call   80100660 <cprintf>
80104259:	83 c4 10             	add    $0x10,%esp
8010425c:	e9 6f fe ff ff       	jmp    801040d0 <cps+0x50>
80104261:	66 90                	xchg   %ax,%ax
...
8010427a:	68 54 78 10 80       	push   $0x80107854
...
801042bf:	e8 3c 02 00 00       	call   80104500 <acquire>
  while (lk->locked) {
...
801042d5:	e8 46 fa ff ff       	call   80103d20 <sleep>
...
801042e3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801042e9:	e8 82 f4 ff ff       	call   80103770 <myproc>
...
801042fc:	5d                   	pop    %ebp
  ...
  lk->pid = myproc()->pid;
  release(&lk->lk);
801042fd:	e9 ae 02 00 00       	jmp    801045b0 <release>
...
8010431f:	e8 dc 01 00 00       	call   80104500 <acquire>
  lk->locked = 0;
...
80104334:	e8 97 fb ff ff       	call   80103ed0 <wakeup>
  release(&lk->lk);
...
80104344:	5d                   	pop    %ebp
{
  ...
  wakeup(lk);
  release(&lk->lk);
80104345:	e9 66 02 00 00       	jmp    801045b0 <release>
...
80104362:	e8 99 01 00 00       	call   80104500 <acquire>
...
80104373:	e8 f8 f3 ff ff       	call   80103770 <myproc>
...
80104387:	e8 24 02 00 00       	call   801045b0 <release>
  return r;
}
...
80104429:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010442a:	e8 a1 f2 ff ff       	call   801036d0 <mycpu>
...
8010443f:	e8 8c f2 ff ff       	call   801036d0 <mycpu>
80104444:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010444a:	e8 81 f2 ff ff       	call   801036d0 <mycpu>
...
8010446b:	75 52                	jne    801044bf <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010446d:	e8 5e f2 ff ff       	call   801036d0 <mycpu>
...
80104485:	e8 46 f2 ff ff       	call   801036d0 <mycpu>
...
80104499:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044a0:	e8 2b f2 ff ff       	call   801036d0 <mycpu>
...
801044b5:	68 76 78 10 80       	push   $0x80107876
...
801044c2:	68 5f 78 10 80       	push   $0x8010785f
...
801044d8:	31 db                	xor    %ebx,%ebx
  int r;
  pushcli();
801044da:	e8 41 ff ff ff       	call   80104420 <pushcli>
...
801044e8:	e8 e3 f1 ff ff       	call   801036d0 <mycpu>
...
80104507:	e8 14 ff ff ff       	call   80104420 <pushcli>
  if(holding(lk))
8010450c:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010450f:	83 ec 0c             	sub    $0xc,%esp
80104512:	53                   	push   %ebx
80104513:	e8 b8 ff ff ff       	call   801044d0 <holding>
80104518:	83 c4 10             	add    $0x10,%esp
8010451b:	85 c0                	test   %eax,%eax
8010451d:	0f 85 7d 00 00 00    	jne    801045a0 <acquire+0xa0>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104544:	e8 87 f1 ff ff       	call   801036d0 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
8010458d:	74 e7                	je     80104576 <acquire+0x76>
    pcs[i] = 0;
...
8010459c:	75 e2                	jne    80104580 <acquire+0x80>
8010459e:	eb d6                	jmp    80104576 <acquire+0x76>
void
acquire(struct spinlock *lk)
{
  pushcli(); // disable interrupts to avoid deadlock.
...
801045a3:	68 7d 78 10 80       	push   $0x8010787d
801045a8:	e8 c3 bd ff ff       	call   80100370 <panic>
...
801045bb:	e8 10 ff ff ff       	call   801044d0 <holding>
...
801045ec:	68 85 78 10 80       	push   $0x80107885
801045f1:	e8 7a bd ff ff       	call   80100370 <panic>
...
80104877:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010487a:	e8 f1 ee ff ff       	call   80103770 <myproc>
...
801048b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801048ba:	e8 b1 ee ff ff       	call   80103770 <myproc>
...
80104915:	e8 56 ee ff ff       	call   80103770 <myproc>
...
{
  struct proc *curproc = myproc();
80104926:	e8 45 ee ff ff       	call   80103770 <myproc>
...
80104968:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010496b:	e8 00 ee ff ff       	call   80103770 <myproc>
...
80104a04:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104a05:	e8 66 ed ff ff       	call   80103770 <myproc>
...
80104a15:	83 fa 15             	cmp    $0x15,%edx
80104a18:	77 1e                	ja     80104a38 <syscall+0x38>
80104a1a:	8b 14 85 c0 78 10 80 	mov    -0x7fef8740(,%eax,4),%edx
...
80104a40:	68 8d 78 10 80       	push   $0x8010788d
...
80104a77:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
80104a7a:	e8 51 d4 ff ff       	call   80101ed0 <nameiparent>
...
80104b58:	e8 93 d2 ff ff       	call   80101df0 <dirlink>
...
80104b82:	e9 47 ff ff ff       	jmp    80104ace <create+0x6e>
...
80104ba4:	68 38 79 10 80       	push   $0x80107938
80104ba9:	53                   	push   %ebx
80104baa:	e8 41 d2 ff ff       	call   80101df0 <dirlink>
...
80104bbc:	68 37 79 10 80       	push   $0x80107937
80104bc1:	53                   	push   %ebx
80104bc2:	e8 29 d2 ff ff       	call   80101df0 <dirlink>
...
80104bd1:	68 2b 79 10 80       	push   $0x8010792b
...
80104bde:	68 3a 79 10 80       	push   $0x8010793a
...
80104beb:	68 1c 79 10 80       	push   $0x8010791c
...
80104c24:	e8 47 eb ff ff       	call   80103770 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104c8b:	e8 e0 ea ff ff       	call   80103770 <myproc>
...
80104cba:	e8 21 c1 ff ff       	call   80100de0 <filedup>
  return fd;
...
80104d1d:	e8 2e c2 ff ff       	call   80100f50 <fileread>
...
80104dc3:	78 2b                	js     80104df0 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104dc5:	e8 a6 e9 ff ff       	call   80103770 <myproc>
...
80104ddb:	e8 50 c0 ff ff       	call   80100e30 <fileclose>
  return 0;
...
80104e34:	e8 c7 c0 ff ff       	call   80100f00 <filestat>
...
80104e82:	0f 88 e2 00 00 00    	js     80104f6a <sys_link+0x11a>
  ...
  begin_op();
80104e88:	e8 b3 dc ff ff       	call   80102b40 <begin_op>
  if((ip = namei(old)) == 0){
80104e8d:	83 ec 0c             	sub    $0xc,%esp
80104e90:	ff 75 d4             	pushl  -0x2c(%ebp)
80104e93:	e8 18 d0 ff ff       	call   80101eb0 <namei>
...
80104edb:	e8 f0 cf ff ff       	call   80101ed0 <nameiparent>
...
80104f03:	e8 e8 ce ff ff       	call   80101df0 <dirlink>
...
80104f1b:	e8 70 c8 ff ff       	call   80101790 <iput>
  ...
  end_op();
80104f20:	e8 8b dc ff ff       	call   80102bb0 <end_op>
...
80104f5d:	e8 8e c9 ff ff       	call   801018f0 <iunlockput>
  end_op();
80104f62:	e8 49 dc ff ff       	call   80102bb0 <end_op>
  return -1;
...
80104f84:	e8 67 c9 ff ff       	call   801018f0 <iunlockput>
    end_op();
80104f89:	e8 22 dc ff ff       	call   80102bb0 <end_op>
    return -1;
...
80104f96:	eb 92                	jmp    80104f2a <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
80104f98:	e8 13 dc ff ff       	call   80102bb0 <end_op>
    return -1;
...
80104fcf:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80104fd2:	e8 69 db ff ff       	call   80102b40 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104fd7:	83 ec 08             	sub    $0x8,%esp
80104fda:	53                   	push   %ebx
80104fdb:	ff 75 c0             	pushl  -0x40(%ebp)
80104fde:	e8 ed ce ff ff       	call   80101ed0 <nameiparent>
...
80104ffd:	58                   	pop    %eax
80104ffe:	5a                   	pop    %edx
80104fff:	68 38 79 10 80       	push   $0x80107938
...
80105018:	68 37 79 10 80       	push   $0x80107937
...
80105156:	e9 6b ff ff ff       	jmp    801050c6 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
8010515b:	e8 50 da ff ff       	call   80102bb0 <end_op>
    return -1;
...
8010516d:	68 5c 79 10 80       	push   $0x8010795c
...
8010517a:	68 6e 79 10 80       	push   $0x8010796e
...
80105187:	68 4a 79 10 80       	push   $0x8010794a
...
801051d2:	0f 88 85 00 00 00    	js     8010525d <sys_open+0xbd>
  ...
  begin_op();
801051d8:	e8 63 d9 ff ff       	call   80102b40 <begin_op>
...
80105216:	e8 55 bb ff ff       	call   80100d70 <filealloc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105223:	e8 48 e5 ff ff       	call   80103770 <myproc>
80105228:	90                   	nop
...
80105244:	e8 e7 bb ff ff       	call   80100e30 <fileclose>
...
80105250:	e8 9b c6 ff ff       	call   801018f0 <iunlockput>
    end_op();
80105255:	e8 56 d9 ff ff       	call   80102bb0 <end_op>
    return -1;
...
801052a8:	e8 93 c4 ff ff       	call   80101740 <iunlock>
  end_op();
801052ad:	e8 fe d8 ff ff       	call   80102bb0 <end_op>
...
8010533f:	e8 ac c5 ff ff       	call   801018f0 <iunlockput>
  end_op();
80105344:	e8 67 d8 ff ff       	call   80102bb0 <end_op>
  return 0;
...
801053ce:	e8 1d c5 ff ff       	call   801018f0 <iunlockput>
  end_op();
801053d3:	e8 d8 d7 ff ff       	call   80102bb0 <end_op>
  return 0;
...
801053df:	90                   	nop
  ...
  if((argstr(0, &path)) < 0 ||
     ...
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
801053e0:	e8 cb d7 ff ff       	call   80102bb0 <end_op>
    return -1;
...
801053f5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801053f8:	e8 73 e3 ff ff       	call   80103770 <myproc>
801053fd:	89 c6                	mov    %eax,%esi
  
  begin_op();
801053ff:	e8 3c d7 ff ff       	call   80102b40 <begin_op>
...
8010541f:	e8 8c ca ff ff       	call   80101eb0 <namei>
...
8010544d:	e8 3e c3 ff ff       	call   80101790 <iput>
  end_op();
80105452:	e8 59 d7 ff ff       	call   80102bb0 <end_op>
  curproc->cwd = ip;
...
80105474:	e8 77 c4 ff ff       	call   801018f0 <iunlockput>
    end_op();
80105479:	e8 32 d7 ff ff       	call   80102bb0 <end_op>
    return -1;
...
801055a8:	e8 33 dc ff ff       	call   801031e0 <pipealloc>
...
801055d6:	e8 55 b8 ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
801055db:	58                   	pop    %eax
801055dc:	ff 75 e4             	pushl  -0x1c(%ebp)
801055df:	e8 4c b8 ff ff       	call   80100e30 <fileclose>
    return -1;
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105602:	e8 69 e1 ff ff       	call   80103770 <myproc>
...
8010561e:	75 f0                	jne    80105610 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105620:	e8 4b e1 ff ff       	call   80103770 <myproc>
...
{
  return fork();
80105654:	e9 b7 e2 ff ff       	jmp    80103910 <fork>
...
80105663:	83 ec 08             	sub    $0x8,%esp
  exit();
80105666:	e8 35 e5 ff ff       	call   80103ba0 <exit>
...
{
  return wait();
80105674:	e9 67 e7 ff ff       	jmp    80103de0 <wait>
...
8010569e:	e8 8d e8 ff ff       	call   80103f30 <kill>
...
801056c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801056c6:	e8 a5 e0 ff ff       	call   80103770 <myproc>
...
801056e7:	78 27                	js     80105710 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801056e9:	e8 82 e0 ff ff       	call   80103770 <myproc>
  if(growproc(n) < 0)
...
801056f6:	e8 95 e1 ff ff       	call   80103890 <growproc>
...
8010576d:	e8 ae e5 ff ff       	call   80103d20 <sleep>
...
8010577f:	73 2f                	jae    801057b0 <sys_sleep+0x90>
    if(myproc()->killed){
80105781:	e8 ea df ff ff       	call   80103770 <myproc>
...
{
  return cps();
80105804:	e9 77 e8 ff ff       	jmp    80104080 <cps>
...
8010580a:	06                   	push   %es
  pushl %fs
8010580b:	0f a0                	push   %fs
  pushl %gs
8010580d:	0f a8                	push   %gs
  pushal
8010580f:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105810:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105814:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105816:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105818:	54                   	push   %esp
  call trap
80105819:	e8 e2 00 00 00       	call   80105900 <trap>
  addl $4, %esp
8010581e:	83 c4 04             	add    $0x4,%esp
...
80105821:	61                   	popa   
  popl %gs
80105822:	0f a9                	pop    %gs
  popl %fs
80105824:	0f a1                	pop    %fs
  popl %es
80105826:	07                   	pop    %es
  popl %ds
80105827:	1f                   	pop    %ds
...
80105844:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
8010584b:	00 
8010584c:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
80105853:	80 
80105854:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
8010585b:	8e 
8010585c:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105863:	80 
80105864:	c1 ea 10             	shr    $0x10,%edx
80105867:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
8010586e:	80 
void
tvinit(void)
{
...
80105889:	68 7d 79 10 80       	push   $0x8010797d
8010588e:	68 60 4c 11 80       	push   $0x80114c60
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105893:	66 89 15 a2 4e 11 80 	mov    %dx,0x80114ea2
8010589a:	c6 05 a4 4e 11 80 00 	movb   $0x0,0x80114ea4
801058a1:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
801058a7:	c1 e8 10             	shr    $0x10,%eax
801058aa:	c6 05 a5 4e 11 80 ef 	movb   $0xef,0x80114ea5
801058b1:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6

  initlock(&tickslock, "time");
801058b7:	e8 e4 ea ff ff       	call   801043a0 <initlock>
}
...
80105920:	ff 24 85 24 7a 10 80 	jmp    *-0x7fef85dc(,%eax,4)
...
80105985:	68 e0 79 10 80       	push   $0x801079e0
...
80105992:	e8 d9 dd ff ff       	call   80103770 <myproc>
...
801059b5:	e8 b6 dd ff ff       	call   80103770 <myproc>
801059ba:	85 c0                	test   %eax,%eax
801059bc:	74 0b                	je     801059c9 <trap+0xc9>
801059be:	e8 ad dd ff ff       	call   80103770 <myproc>
...
801059c7:	74 4f                	je     80105a18 <trap+0x118>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059c9:	e8 a2 dd ff ff       	call   80103770 <myproc>
801059ce:	85 c0                	test   %eax,%eax
801059d0:	74 1d                	je     801059ef <trap+0xef>
801059d2:	e8 99 dd ff ff       	call   80103770 <myproc>
...
80105a0b:	75 a8                	jne    801059b5 <trap+0xb5>
    exit();
80105a0d:	e8 8e e1 ff ff       	call   80103ba0 <exit>
...
80105a1c:	75 ab                	jne    801059c9 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105a1e:	e8 ad e2 ff ff       	call   80103cd0 <yield>
...
80105a25:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105a28:	e8 23 dd ff ff       	call   80103750 <cpuid>
...
80105a2f:	0f 84 ab 00 00 00    	je     80105ae0 <trap+0x1e0>
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105a35:	e8 c6 cc ff ff       	call   80102700 <lapiceoi>
    break;
...
80105a3f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105a40:	e8 7b cb ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
80105a45:	e8 b6 cc ff ff       	call   80102700 <lapiceoi>
    break;
...
80105a50:	e8 5b 02 00 00       	call   80105cb0 <uartintr>
    lapiceoi();
80105a55:	e8 a6 cc ff ff       	call   80102700 <lapiceoi>
    break;
...
80105a67:	e8 e4 dc ff ff       	call   80103750 <cpuid>
80105a6c:	56                   	push   %esi
80105a6d:	53                   	push   %ebx
80105a6e:	50                   	push   %eax
80105a6f:	68 88 79 10 80       	push   $0x80107988
80105a74:	e8 e7 ab ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105a79:	e8 82 cc ff ff       	call   80102700 <lapiceoi>
    break;
...
80105a89:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105a90:	e8 ab c5 ff ff       	call   80102040 <ideintr>
...
80105aaa:	75 2c                	jne    80105ad8 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
80105aac:	e8 bf dc ff ff       	call   80103770 <myproc>
80105ab1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105ab4:	e8 47 ef ff ff       	call   80104a00 <syscall>
    if(myproc()->killed)
80105ab9:	e8 b2 dc ff ff       	call   80103770 <myproc>
...
80105acf:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105ad0:	e9 cb e0 ff ff       	jmp    80103ba0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105ad8:	e8 c3 e0 ff ff       	call   80103ba0 <exit>
...
80105ae8:	e8 13 ea ff ff       	call   80104500 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105af4:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105afb:	e8 d0 e3 ff ff       	call   80103ed0 <wakeup>
      release(&tickslock);
...
80105b1a:	e8 31 dc ff ff       	call   80103750 <cpuid>
...
80105b28:	68 ac 79 10 80       	push   $0x801079ac
80105b2d:	e8 2e ab ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105b32:	83 c4 14             	add    $0x14,%esp
80105b35:	68 82 79 10 80       	push   $0x80107982
...
80105b95:	e8 86 cb ff ff       	call   80102720 <microdelay>
{
  int i;
...
80105c2f:	bb a4 7a 10 80       	mov    $0x80107aa4,%ebx
80105c34:	6a 00                	push   $0x0
80105c36:	6a 04                	push   $0x4
80105c38:	e8 53 c6 ff ff       	call   80102290 <ioapicenable>
...
80105cc7:	6a 00                	push   $0x0
  jmp alltraps
80105cc9:	e9 3b fb ff ff       	jmp    80105809 <alltraps>
...
80105cd0:	6a 01                	push   $0x1
  jmp alltraps
80105cd2:	e9 32 fb ff ff       	jmp    80105809 <alltraps>
...
80105cd9:	6a 02                	push   $0x2
  jmp alltraps
80105cdb:	e9 29 fb ff ff       	jmp    80105809 <alltraps>
...
80105ce2:	6a 03                	push   $0x3
  jmp alltraps
80105ce4:	e9 20 fb ff ff       	jmp    80105809 <alltraps>
...
80105ceb:	6a 04                	push   $0x4
  jmp alltraps
80105ced:	e9 17 fb ff ff       	jmp    80105809 <alltraps>
...
80105cf4:	6a 05                	push   $0x5
  jmp alltraps
80105cf6:	e9 0e fb ff ff       	jmp    80105809 <alltraps>
...
80105cfd:	6a 06                	push   $0x6
  jmp alltraps
80105cff:	e9 05 fb ff ff       	jmp    80105809 <alltraps>
...
80105d06:	6a 07                	push   $0x7
  jmp alltraps
80105d08:	e9 fc fa ff ff       	jmp    80105809 <alltraps>
...
80105d0d:	6a 08                	push   $0x8
  jmp alltraps
80105d0f:	e9 f5 fa ff ff       	jmp    80105809 <alltraps>
...
80105d16:	6a 09                	push   $0x9
  jmp alltraps
80105d18:	e9 ec fa ff ff       	jmp    80105809 <alltraps>
...
80105d1d:	6a 0a                	push   $0xa
  jmp alltraps
80105d1f:	e9 e5 fa ff ff       	jmp    80105809 <alltraps>
...
80105d24:	6a 0b                	push   $0xb
  jmp alltraps
80105d26:	e9 de fa ff ff       	jmp    80105809 <alltraps>
...
80105d2b:	6a 0c                	push   $0xc
  jmp alltraps
80105d2d:	e9 d7 fa ff ff       	jmp    80105809 <alltraps>
...
80105d32:	6a 0d                	push   $0xd
  jmp alltraps
80105d34:	e9 d0 fa ff ff       	jmp    80105809 <alltraps>
...
80105d39:	6a 0e                	push   $0xe
  jmp alltraps
80105d3b:	e9 c9 fa ff ff       	jmp    80105809 <alltraps>
...
80105d42:	6a 0f                	push   $0xf
  jmp alltraps
80105d44:	e9 c0 fa ff ff       	jmp    80105809 <alltraps>
...
80105d4b:	6a 10                	push   $0x10
  jmp alltraps
80105d4d:	e9 b7 fa ff ff       	jmp    80105809 <alltraps>
...
80105d52:	6a 11                	push   $0x11
  jmp alltraps
80105d54:	e9 b0 fa ff ff       	jmp    80105809 <alltraps>
...
80105d5b:	6a 12                	push   $0x12
  jmp alltraps
80105d5d:	e9 a7 fa ff ff       	jmp    80105809 <alltraps>
...
80105d64:	6a 13                	push   $0x13
  jmp alltraps
80105d66:	e9 9e fa ff ff       	jmp    80105809 <alltraps>
...
80105d6d:	6a 14                	push   $0x14
  jmp alltraps
80105d6f:	e9 95 fa ff ff       	jmp    80105809 <alltraps>
...
80105d76:	6a 15                	push   $0x15
  jmp alltraps
80105d78:	e9 8c fa ff ff       	jmp    80105809 <alltraps>
...
80105d7f:	6a 16                	push   $0x16
  jmp alltraps
80105d81:	e9 83 fa ff ff       	jmp    80105809 <alltraps>
...
80105d88:	6a 17                	push   $0x17
  jmp alltraps
80105d8a:	e9 7a fa ff ff       	jmp    80105809 <alltraps>
...
80105d91:	6a 18                	push   $0x18
  jmp alltraps
80105d93:	e9 71 fa ff ff       	jmp    80105809 <alltraps>
...
80105d9a:	6a 19                	push   $0x19
  jmp alltraps
80105d9c:	e9 68 fa ff ff       	jmp    80105809 <alltraps>
...
80105da3:	6a 1a                	push   $0x1a
  jmp alltraps
80105da5:	e9 5f fa ff ff       	jmp    80105809 <alltraps>
...
80105dac:	6a 1b                	push   $0x1b
  jmp alltraps
80105dae:	e9 56 fa ff ff       	jmp    80105809 <alltraps>
...
80105db5:	6a 1c                	push   $0x1c
  jmp alltraps
80105db7:	e9 4d fa ff ff       	jmp    80105809 <alltraps>
...
80105dbe:	6a 1d                	push   $0x1d
  jmp alltraps
80105dc0:	e9 44 fa ff ff       	jmp    80105809 <alltraps>
...
80105dc7:	6a 1e                	push   $0x1e
  jmp alltraps
80105dc9:	e9 3b fa ff ff       	jmp    80105809 <alltraps>
...
80105dd0:	6a 1f                	push   $0x1f
  jmp alltraps
80105dd2:	e9 32 fa ff ff       	jmp    80105809 <alltraps>
...
80105dd9:	6a 20                	push   $0x20
  jmp alltraps
80105ddb:	e9 29 fa ff ff       	jmp    80105809 <alltraps>
...
80105de2:	6a 21                	push   $0x21
  jmp alltraps
80105de4:	e9 20 fa ff ff       	jmp    80105809 <alltraps>
...
80105deb:	6a 22                	push   $0x22
  jmp alltraps
80105ded:	e9 17 fa ff ff       	jmp    80105809 <alltraps>
...
80105df4:	6a 23                	push   $0x23
  jmp alltraps
80105df6:	e9 0e fa ff ff       	jmp    80105809 <alltraps>
...
80105dfd:	6a 24                	push   $0x24
  jmp alltraps
80105dff:	e9 05 fa ff ff       	jmp    80105809 <alltraps>
...
80105e06:	6a 25                	push   $0x25
  jmp alltraps
80105e08:	e9 fc f9 ff ff       	jmp    80105809 <alltraps>
...
80105e0f:	6a 26                	push   $0x26
  jmp alltraps
80105e11:	e9 f3 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e18:	6a 27                	push   $0x27
  jmp alltraps
80105e1a:	e9 ea f9 ff ff       	jmp    80105809 <alltraps>
...
80105e21:	6a 28                	push   $0x28
  jmp alltraps
80105e23:	e9 e1 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e2a:	6a 29                	push   $0x29
  jmp alltraps
80105e2c:	e9 d8 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e33:	6a 2a                	push   $0x2a
  jmp alltraps
80105e35:	e9 cf f9 ff ff       	jmp    80105809 <alltraps>
...
80105e3c:	6a 2b                	push   $0x2b
  jmp alltraps
80105e3e:	e9 c6 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e45:	6a 2c                	push   $0x2c
  jmp alltraps
80105e47:	e9 bd f9 ff ff       	jmp    80105809 <alltraps>
...
80105e4e:	6a 2d                	push   $0x2d
  jmp alltraps
80105e50:	e9 b4 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e57:	6a 2e                	push   $0x2e
  jmp alltraps
80105e59:	e9 ab f9 ff ff       	jmp    80105809 <alltraps>
...
80105e60:	6a 2f                	push   $0x2f
  jmp alltraps
80105e62:	e9 a2 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e69:	6a 30                	push   $0x30
  jmp alltraps
80105e6b:	e9 99 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e72:	6a 31                	push   $0x31
  jmp alltraps
80105e74:	e9 90 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e7b:	6a 32                	push   $0x32
  jmp alltraps
80105e7d:	e9 87 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e84:	6a 33                	push   $0x33
  jmp alltraps
80105e86:	e9 7e f9 ff ff       	jmp    80105809 <alltraps>
...
80105e8d:	6a 34                	push   $0x34
  jmp alltraps
80105e8f:	e9 75 f9 ff ff       	jmp    80105809 <alltraps>
...
80105e96:	6a 35                	push   $0x35
  jmp alltraps
80105e98:	e9 6c f9 ff ff       	jmp    80105809 <alltraps>
...
80105e9f:	6a 36                	push   $0x36
  jmp alltraps
80105ea1:	e9 63 f9 ff ff       	jmp    80105809 <alltraps>
...
80105ea8:	6a 37                	push   $0x37
  jmp alltraps
80105eaa:	e9 5a f9 ff ff       	jmp    80105809 <alltraps>
...
80105eb1:	6a 38                	push   $0x38
  jmp alltraps
80105eb3:	e9 51 f9 ff ff       	jmp    80105809 <alltraps>
...
80105eba:	6a 39                	push   $0x39
  jmp alltraps
80105ebc:	e9 48 f9 ff ff       	jmp    80105809 <alltraps>
...
80105ec3:	6a 3a                	push   $0x3a
  jmp alltraps
80105ec5:	e9 3f f9 ff ff       	jmp    80105809 <alltraps>
...
80105ecc:	6a 3b                	push   $0x3b
  jmp alltraps
80105ece:	e9 36 f9 ff ff       	jmp    80105809 <alltraps>
...
80105ed5:	6a 3c                	push   $0x3c
  jmp alltraps
80105ed7:	e9 2d f9 ff ff       	jmp    80105809 <alltraps>
...
80105ede:	6a 3d                	push   $0x3d
  jmp alltraps
80105ee0:	e9 24 f9 ff ff       	jmp    80105809 <alltraps>
...
80105ee7:	6a 3e                	push   $0x3e
  jmp alltraps
80105ee9:	e9 1b f9 ff ff       	jmp    80105809 <alltraps>
...
80105ef0:	6a 3f                	push   $0x3f
  jmp alltraps
80105ef2:	e9 12 f9 ff ff       	jmp    80105809 <alltraps>
...
80105ef9:	6a 40                	push   $0x40
  jmp alltraps
80105efb:	e9 09 f9 ff ff       	jmp    80105809 <alltraps>
...
80105f02:	6a 41                	push   $0x41
  jmp alltraps
80105f04:	e9 00 f9 ff ff       	jmp    80105809 <alltraps>
...
80105f0b:	6a 42                	push   $0x42
  jmp alltraps
80105f0d:	e9 f7 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f14:	6a 43                	push   $0x43
  jmp alltraps
80105f16:	e9 ee f8 ff ff       	jmp    80105809 <alltraps>
...
80105f1d:	6a 44                	push   $0x44
  jmp alltraps
80105f1f:	e9 e5 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f26:	6a 45                	push   $0x45
  jmp alltraps
80105f28:	e9 dc f8 ff ff       	jmp    80105809 <alltraps>
...
80105f2f:	6a 46                	push   $0x46
  jmp alltraps
80105f31:	e9 d3 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f38:	6a 47                	push   $0x47
  jmp alltraps
80105f3a:	e9 ca f8 ff ff       	jmp    80105809 <alltraps>
...
80105f41:	6a 48                	push   $0x48
  jmp alltraps
80105f43:	e9 c1 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f4a:	6a 49                	push   $0x49
  jmp alltraps
80105f4c:	e9 b8 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f53:	6a 4a                	push   $0x4a
  jmp alltraps
80105f55:	e9 af f8 ff ff       	jmp    80105809 <alltraps>
...
80105f5c:	6a 4b                	push   $0x4b
  jmp alltraps
80105f5e:	e9 a6 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f65:	6a 4c                	push   $0x4c
  jmp alltraps
80105f67:	e9 9d f8 ff ff       	jmp    80105809 <alltraps>
...
80105f6e:	6a 4d                	push   $0x4d
  jmp alltraps
80105f70:	e9 94 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f77:	6a 4e                	push   $0x4e
  jmp alltraps
80105f79:	e9 8b f8 ff ff       	jmp    80105809 <alltraps>
...
80105f80:	6a 4f                	push   $0x4f
  jmp alltraps
80105f82:	e9 82 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f89:	6a 50                	push   $0x50
  jmp alltraps
80105f8b:	e9 79 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f92:	6a 51                	push   $0x51
  jmp alltraps
80105f94:	e9 70 f8 ff ff       	jmp    80105809 <alltraps>
...
80105f9b:	6a 52                	push   $0x52
  jmp alltraps
80105f9d:	e9 67 f8 ff ff       	jmp    80105809 <alltraps>
...
80105fa4:	6a 53                	push   $0x53
  jmp alltraps
80105fa6:	e9 5e f8 ff ff       	jmp    80105809 <alltraps>
...
80105fad:	6a 54                	push   $0x54
  jmp alltraps
80105faf:	e9 55 f8 ff ff       	jmp    80105809 <alltraps>
...
80105fb6:	6a 55                	push   $0x55
  jmp alltraps
80105fb8:	e9 4c f8 ff ff       	jmp    80105809 <alltraps>
...
80105fbf:	6a 56                	push   $0x56
  jmp alltraps
80105fc1:	e9 43 f8 ff ff       	jmp    80105809 <alltraps>
...
80105fc8:	6a 57                	push   $0x57
  jmp alltraps
80105fca:	e9 3a f8 ff ff       	jmp    80105809 <alltraps>
...
80105fd1:	6a 58                	push   $0x58
  jmp alltraps
80105fd3:	e9 31 f8 ff ff       	jmp    80105809 <alltraps>
...
80105fda:	6a 59                	push   $0x59
  jmp alltraps
80105fdc:	e9 28 f8 ff ff       	jmp    80105809 <alltraps>
...
80105fe3:	6a 5a                	push   $0x5a
  jmp alltraps
80105fe5:	e9 1f f8 ff ff       	jmp    80105809 <alltraps>
...
80105fec:	6a 5b                	push   $0x5b
  jmp alltraps
80105fee:	e9 16 f8 ff ff       	jmp    80105809 <alltraps>
...
80105ff5:	6a 5c                	push   $0x5c
  jmp alltraps
80105ff7:	e9 0d f8 ff ff       	jmp    80105809 <alltraps>
...
80105ffe:	6a 5d                	push   $0x5d
  jmp alltraps
80106000:	e9 04 f8 ff ff       	jmp    80105809 <alltraps>
...
80106007:	6a 5e                	push   $0x5e
  jmp alltraps
80106009:	e9 fb f7 ff ff       	jmp    80105809 <alltraps>
...
80106010:	6a 5f                	push   $0x5f
  jmp alltraps
80106012:	e9 f2 f7 ff ff       	jmp    80105809 <alltraps>
...
80106019:	6a 60                	push   $0x60
  jmp alltraps
8010601b:	e9 e9 f7 ff ff       	jmp    80105809 <alltraps>
...
80106022:	6a 61                	push   $0x61
  jmp alltraps
80106024:	e9 e0 f7 ff ff       	jmp    80105809 <alltraps>
...
8010602b:	6a 62                	push   $0x62
  jmp alltraps
8010602d:	e9 d7 f7 ff ff       	jmp    80105809 <alltraps>
...
80106034:	6a 63                	push   $0x63
  jmp alltraps
80106036:	e9 ce f7 ff ff       	jmp    80105809 <alltraps>
...
8010603d:	6a 64                	push   $0x64
  jmp alltraps
8010603f:	e9 c5 f7 ff ff       	jmp    80105809 <alltraps>
...
80106046:	6a 65                	push   $0x65
  jmp alltraps
80106048:	e9 bc f7 ff ff       	jmp    80105809 <alltraps>
...
8010604f:	6a 66                	push   $0x66
  jmp alltraps
80106051:	e9 b3 f7 ff ff       	jmp    80105809 <alltraps>
...
80106058:	6a 67                	push   $0x67
  jmp alltraps
8010605a:	e9 aa f7 ff ff       	jmp    80105809 <alltraps>
...
80106061:	6a 68                	push   $0x68
  jmp alltraps
80106063:	e9 a1 f7 ff ff       	jmp    80105809 <alltraps>
...
8010606a:	6a 69                	push   $0x69
  jmp alltraps
8010606c:	e9 98 f7 ff ff       	jmp    80105809 <alltraps>
...
80106073:	6a 6a                	push   $0x6a
  jmp alltraps
80106075:	e9 8f f7 ff ff       	jmp    80105809 <alltraps>
...
8010607c:	6a 6b                	push   $0x6b
  jmp alltraps
8010607e:	e9 86 f7 ff ff       	jmp    80105809 <alltraps>
...
80106085:	6a 6c                	push   $0x6c
  jmp alltraps
80106087:	e9 7d f7 ff ff       	jmp    80105809 <alltraps>
...
8010608e:	6a 6d                	push   $0x6d
  jmp alltraps
80106090:	e9 74 f7 ff ff       	jmp    80105809 <alltraps>
...
80106097:	6a 6e                	push   $0x6e
  jmp alltraps
80106099:	e9 6b f7 ff ff       	jmp    80105809 <alltraps>
...
801060a0:	6a 6f                	push   $0x6f
  jmp alltraps
801060a2:	e9 62 f7 ff ff       	jmp    80105809 <alltraps>
...
801060a9:	6a 70                	push   $0x70
  jmp alltraps
801060ab:	e9 59 f7 ff ff       	jmp    80105809 <alltraps>
...
801060b2:	6a 71                	push   $0x71
  jmp alltraps
801060b4:	e9 50 f7 ff ff       	jmp    80105809 <alltraps>
...
801060bb:	6a 72                	push   $0x72
  jmp alltraps
801060bd:	e9 47 f7 ff ff       	jmp    80105809 <alltraps>
...
801060c4:	6a 73                	push   $0x73
  jmp alltraps
801060c6:	e9 3e f7 ff ff       	jmp    80105809 <alltraps>
...
801060cd:	6a 74                	push   $0x74
  jmp alltraps
801060cf:	e9 35 f7 ff ff       	jmp    80105809 <alltraps>
...
801060d6:	6a 75                	push   $0x75
  jmp alltraps
801060d8:	e9 2c f7 ff ff       	jmp    80105809 <alltraps>
...
801060df:	6a 76                	push   $0x76
  jmp alltraps
801060e1:	e9 23 f7 ff ff       	jmp    80105809 <alltraps>
...
801060e8:	6a 77                	push   $0x77
  jmp alltraps
801060ea:	e9 1a f7 ff ff       	jmp    80105809 <alltraps>
...
801060f1:	6a 78                	push   $0x78
  jmp alltraps
801060f3:	e9 11 f7 ff ff       	jmp    80105809 <alltraps>
...
801060fa:	6a 79                	push   $0x79
  jmp alltraps
801060fc:	e9 08 f7 ff ff       	jmp    80105809 <alltraps>
...
80106103:	6a 7a                	push   $0x7a
  jmp alltraps
80106105:	e9 ff f6 ff ff       	jmp    80105809 <alltraps>
...
8010610c:	6a 7b                	push   $0x7b
  jmp alltraps
8010610e:	e9 f6 f6 ff ff       	jmp    80105809 <alltraps>
...
80106115:	6a 7c                	push   $0x7c
  jmp alltraps
80106117:	e9 ed f6 ff ff       	jmp    80105809 <alltraps>
...
8010611e:	6a 7d                	push   $0x7d
  jmp alltraps
80106120:	e9 e4 f6 ff ff       	jmp    80105809 <alltraps>
...
80106127:	6a 7e                	push   $0x7e
  jmp alltraps
80106129:	e9 db f6 ff ff       	jmp    80105809 <alltraps>
...
80106130:	6a 7f                	push   $0x7f
  jmp alltraps
80106132:	e9 d2 f6 ff ff       	jmp    80105809 <alltraps>
...
80106139:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010613e:	e9 c6 f6 ff ff       	jmp    80105809 <alltraps>
...
80106145:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010614a:	e9 ba f6 ff ff       	jmp    80105809 <alltraps>
...
80106151:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106156:	e9 ae f6 ff ff       	jmp    80105809 <alltraps>
...
8010615d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106162:	e9 a2 f6 ff ff       	jmp    80105809 <alltraps>
...
80106169:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010616e:	e9 96 f6 ff ff       	jmp    80105809 <alltraps>
...
80106175:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010617a:	e9 8a f6 ff ff       	jmp    80105809 <alltraps>
...
80106181:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106186:	e9 7e f6 ff ff       	jmp    80105809 <alltraps>
...
8010618d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106192:	e9 72 f6 ff ff       	jmp    80105809 <alltraps>
...
80106199:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010619e:	e9 66 f6 ff ff       	jmp    80105809 <alltraps>
...
801061a5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801061aa:	e9 5a f6 ff ff       	jmp    80105809 <alltraps>
...
801061b1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801061b6:	e9 4e f6 ff ff       	jmp    80105809 <alltraps>
...
801061bd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801061c2:	e9 42 f6 ff ff       	jmp    80105809 <alltraps>
...
801061c9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801061ce:	e9 36 f6 ff ff       	jmp    80105809 <alltraps>
...
801061d5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801061da:	e9 2a f6 ff ff       	jmp    80105809 <alltraps>
...
801061e1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801061e6:	e9 1e f6 ff ff       	jmp    80105809 <alltraps>
...
801061ed:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801061f2:	e9 12 f6 ff ff       	jmp    80105809 <alltraps>
...
801061f9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801061fe:	e9 06 f6 ff ff       	jmp    80105809 <alltraps>
...
80106205:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010620a:	e9 fa f5 ff ff       	jmp    80105809 <alltraps>
...
80106211:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106216:	e9 ee f5 ff ff       	jmp    80105809 <alltraps>
...
8010621d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106222:	e9 e2 f5 ff ff       	jmp    80105809 <alltraps>
...
80106229:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010622e:	e9 d6 f5 ff ff       	jmp    80105809 <alltraps>
...
80106235:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010623a:	e9 ca f5 ff ff       	jmp    80105809 <alltraps>
...
80106241:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106246:	e9 be f5 ff ff       	jmp    80105809 <alltraps>
...
8010624d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106252:	e9 b2 f5 ff ff       	jmp    80105809 <alltraps>
...
80106259:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010625e:	e9 a6 f5 ff ff       	jmp    80105809 <alltraps>
...
80106265:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010626a:	e9 9a f5 ff ff       	jmp    80105809 <alltraps>
...
80106271:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106276:	e9 8e f5 ff ff       	jmp    80105809 <alltraps>
...
8010627d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106282:	e9 82 f5 ff ff       	jmp    80105809 <alltraps>
...
80106289:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010628e:	e9 76 f5 ff ff       	jmp    80105809 <alltraps>
...
80106295:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010629a:	e9 6a f5 ff ff       	jmp    80105809 <alltraps>
...
801062a1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801062a6:	e9 5e f5 ff ff       	jmp    80105809 <alltraps>
...
801062ad:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801062b2:	e9 52 f5 ff ff       	jmp    80105809 <alltraps>
...
801062b9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801062be:	e9 46 f5 ff ff       	jmp    80105809 <alltraps>
...
801062c5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801062ca:	e9 3a f5 ff ff       	jmp    80105809 <alltraps>
...
801062d1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801062d6:	e9 2e f5 ff ff       	jmp    80105809 <alltraps>
...
801062dd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801062e2:	e9 22 f5 ff ff       	jmp    80105809 <alltraps>
...
801062e9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801062ee:	e9 16 f5 ff ff       	jmp    80105809 <alltraps>
...
801062f5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801062fa:	e9 0a f5 ff ff       	jmp    80105809 <alltraps>
...
80106301:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106306:	e9 fe f4 ff ff       	jmp    80105809 <alltraps>
...
8010630d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106312:	e9 f2 f4 ff ff       	jmp    80105809 <alltraps>
...
80106319:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010631e:	e9 e6 f4 ff ff       	jmp    80105809 <alltraps>
...
80106325:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010632a:	e9 da f4 ff ff       	jmp    80105809 <alltraps>
...
80106331:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106336:	e9 ce f4 ff ff       	jmp    80105809 <alltraps>
...
8010633d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106342:	e9 c2 f4 ff ff       	jmp    80105809 <alltraps>
...
80106349:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010634e:	e9 b6 f4 ff ff       	jmp    80105809 <alltraps>
...
80106355:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010635a:	e9 aa f4 ff ff       	jmp    80105809 <alltraps>
...
80106361:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106366:	e9 9e f4 ff ff       	jmp    80105809 <alltraps>
...
8010636d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106372:	e9 92 f4 ff ff       	jmp    80105809 <alltraps>
...
80106379:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010637e:	e9 86 f4 ff ff       	jmp    80105809 <alltraps>
...
80106385:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010638a:	e9 7a f4 ff ff       	jmp    80105809 <alltraps>
...
80106391:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106396:	e9 6e f4 ff ff       	jmp    80105809 <alltraps>
...
8010639d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801063a2:	e9 62 f4 ff ff       	jmp    80105809 <alltraps>
...
801063a9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801063ae:	e9 56 f4 ff ff       	jmp    80105809 <alltraps>
...
801063b5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801063ba:	e9 4a f4 ff ff       	jmp    80105809 <alltraps>
...
801063c1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801063c6:	e9 3e f4 ff ff       	jmp    80105809 <alltraps>
...
801063cd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801063d2:	e9 32 f4 ff ff       	jmp    80105809 <alltraps>
...
801063d9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801063de:	e9 26 f4 ff ff       	jmp    80105809 <alltraps>
...
801063e5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801063ea:	e9 1a f4 ff ff       	jmp    80105809 <alltraps>
...
801063f1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801063f6:	e9 0e f4 ff ff       	jmp    80105809 <alltraps>
...
801063fd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106402:	e9 02 f4 ff ff       	jmp    80105809 <alltraps>
...
80106409:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010640e:	e9 f6 f3 ff ff       	jmp    80105809 <alltraps>
...
80106415:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010641a:	e9 ea f3 ff ff       	jmp    80105809 <alltraps>
...
80106421:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106426:	e9 de f3 ff ff       	jmp    80105809 <alltraps>
...
8010642d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106432:	e9 d2 f3 ff ff       	jmp    80105809 <alltraps>
...
80106439:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010643e:	e9 c6 f3 ff ff       	jmp    80105809 <alltraps>
...
80106445:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010644a:	e9 ba f3 ff ff       	jmp    80105809 <alltraps>
...
80106451:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106456:	e9 ae f3 ff ff       	jmp    80105809 <alltraps>
...
8010645d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106462:	e9 a2 f3 ff ff       	jmp    80105809 <alltraps>
...
80106469:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010646e:	e9 96 f3 ff ff       	jmp    80105809 <alltraps>
...
80106475:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010647a:	e9 8a f3 ff ff       	jmp    80105809 <alltraps>
...
80106481:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106486:	e9 7e f3 ff ff       	jmp    80105809 <alltraps>
...
8010648d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106492:	e9 72 f3 ff ff       	jmp    80105809 <alltraps>
...
80106499:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010649e:	e9 66 f3 ff ff       	jmp    80105809 <alltraps>
...
801064a5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801064aa:	e9 5a f3 ff ff       	jmp    80105809 <alltraps>
...
801064b1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801064b6:	e9 4e f3 ff ff       	jmp    80105809 <alltraps>
...
801064bd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801064c2:	e9 42 f3 ff ff       	jmp    80105809 <alltraps>
...
801064c9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801064ce:	e9 36 f3 ff ff       	jmp    80105809 <alltraps>
...
801064d5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801064da:	e9 2a f3 ff ff       	jmp    80105809 <alltraps>
...
801064e1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801064e6:	e9 1e f3 ff ff       	jmp    80105809 <alltraps>
...
801064ed:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801064f2:	e9 12 f3 ff ff       	jmp    80105809 <alltraps>
...
801064f9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801064fe:	e9 06 f3 ff ff       	jmp    80105809 <alltraps>
...
80106505:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010650a:	e9 fa f2 ff ff       	jmp    80105809 <alltraps>
...
80106511:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106516:	e9 ee f2 ff ff       	jmp    80105809 <alltraps>
...
8010651d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106522:	e9 e2 f2 ff ff       	jmp    80105809 <alltraps>
...
80106529:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010652e:	e9 d6 f2 ff ff       	jmp    80105809 <alltraps>
...
80106535:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010653a:	e9 ca f2 ff ff       	jmp    80105809 <alltraps>
...
80106541:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106546:	e9 be f2 ff ff       	jmp    80105809 <alltraps>
...
8010654d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106552:	e9 b2 f2 ff ff       	jmp    80105809 <alltraps>
...
80106559:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010655e:	e9 a6 f2 ff ff       	jmp    80105809 <alltraps>
...
80106565:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010656a:	e9 9a f2 ff ff       	jmp    80105809 <alltraps>
...
80106571:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106576:	e9 8e f2 ff ff       	jmp    80105809 <alltraps>
...
8010657d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106582:	e9 82 f2 ff ff       	jmp    80105809 <alltraps>
...
80106589:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010658e:	e9 76 f2 ff ff       	jmp    80105809 <alltraps>
...
80106595:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010659a:	e9 6a f2 ff ff       	jmp    80105809 <alltraps>
...
801065a1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801065a6:	e9 5e f2 ff ff       	jmp    80105809 <alltraps>
...
801065ad:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801065b2:	e9 52 f2 ff ff       	jmp    80105809 <alltraps>
...
801065b9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801065be:	e9 46 f2 ff ff       	jmp    80105809 <alltraps>
...
801065c5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801065ca:	e9 3a f2 ff ff       	jmp    80105809 <alltraps>
...
801065d1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801065d6:	e9 2e f2 ff ff       	jmp    80105809 <alltraps>
...
801065dd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801065e2:	e9 22 f2 ff ff       	jmp    80105809 <alltraps>
...
801065e9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801065ee:	e9 16 f2 ff ff       	jmp    80105809 <alltraps>
...
801065f5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801065fa:	e9 0a f2 ff ff       	jmp    80105809 <alltraps>
...
80106601:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106606:	e9 fe f1 ff ff       	jmp    80105809 <alltraps>
...
8010660d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106612:	e9 f2 f1 ff ff       	jmp    80105809 <alltraps>
...
80106619:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010661e:	e9 e6 f1 ff ff       	jmp    80105809 <alltraps>
...
80106625:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010662a:	e9 da f1 ff ff       	jmp    80105809 <alltraps>
...
80106631:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106636:	e9 ce f1 ff ff       	jmp    80105809 <alltraps>
...
8010663d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106642:	e9 c2 f1 ff ff       	jmp    80105809 <alltraps>
...
80106649:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010664e:	e9 b6 f1 ff ff       	jmp    80105809 <alltraps>
...
80106655:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010665a:	e9 aa f1 ff ff       	jmp    80105809 <alltraps>
...
80106661:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106666:	e9 9e f1 ff ff       	jmp    80105809 <alltraps>
...
8010666d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106672:	e9 92 f1 ff ff       	jmp    80105809 <alltraps>
...
80106679:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010667e:	e9 86 f1 ff ff       	jmp    80105809 <alltraps>
...
80106685:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010668a:	e9 7a f1 ff ff       	jmp    80105809 <alltraps>
...
80106691:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106696:	e9 6e f1 ff ff       	jmp    80105809 <alltraps>
...
8010669d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801066a2:	e9 62 f1 ff ff       	jmp    80105809 <alltraps>
...
801066a9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801066ae:	e9 56 f1 ff ff       	jmp    80105809 <alltraps>
...
801066b5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801066ba:	e9 4a f1 ff ff       	jmp    80105809 <alltraps>
...
801066c1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801066c6:	e9 3e f1 ff ff       	jmp    80105809 <alltraps>
...
801066cd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066d2:	e9 32 f1 ff ff       	jmp    80105809 <alltraps>
...
801066d9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066de:	e9 26 f1 ff ff       	jmp    80105809 <alltraps>
...
801066e5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801066ea:	e9 1a f1 ff ff       	jmp    80105809 <alltraps>
...
801066f1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801066f6:	e9 0e f1 ff ff       	jmp    80105809 <alltraps>
...
801066fd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106702:	e9 02 f1 ff ff       	jmp    80105809 <alltraps>
...
80106709:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010670e:	e9 f6 f0 ff ff       	jmp    80105809 <alltraps>
...
80106715:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010671a:	e9 ea f0 ff ff       	jmp    80105809 <alltraps>
...
80106721:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106726:	e9 de f0 ff ff       	jmp    80105809 <alltraps>
...
8010672d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106732:	e9 d2 f0 ff ff       	jmp    80105809 <alltraps>
...
80106784:	e8 f7 bc ff ff       	call   80102480 <kalloc>
...
8010679a:	e8 61 de ff ff       	call   80104600 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010683d:	68 ac 7a 10 80       	push   $0x80107aac
...
80106894:	e8 37 ba ff ff       	call   801022d0 <kfree>
      *pte = 0;
...
801068f3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801068f6:	e8 55 ce ff ff       	call   80103750 <cpuid>
...
801069f0:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106a3f:	e8 8c cc ff ff       	call   801036d0 <mycpu>
80106a44:	89 c3                	mov    %eax,%ebx
80106a46:	e8 85 cc ff ff       	call   801036d0 <mycpu>
80106a4b:	89 c7                	mov    %eax,%edi
80106a4d:	e8 7e cc ff ff       	call   801036d0 <mycpu>
80106a52:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a55:	83 c7 08             	add    $0x8,%edi
80106a58:	e8 73 cc ff ff       	call   801036d0 <mycpu>
...
80106a99:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106a9e:	e8 2d cc ff ff       	call   801036d0 <mycpu>
80106aa3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106aaa:	e8 21 cc ff ff       	call   801036d0 <mycpu>
80106aaf:	b9 10 00 00 00       	mov    $0x10,%ecx
80106ab4:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106ab8:	e8 13 cc ff ff       	call   801036d0 <mycpu>
...
80106ac6:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106ac9:	e8 02 cc ff ff       	call   801036d0 <mycpu>
...
80106aeb:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106aec:	e9 6f d9 ff ff       	jmp    80104460 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106af4:	68 b2 7a 10 80       	push   $0x80107ab2
...
80106b01:	68 dd 7a 10 80       	push   $0x80107add
...
80106b0e:	68 c8 7a 10 80       	push   $0x80107ac8
...
80106b3b:	77 49                	ja     80106b86 <inituvm+0x66>
  ...
  mem = kalloc();
80106b3d:	e8 3e b9 ff ff       	call   80102480 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b4f:	e8 ac da ff ff       	call   80104600 <memset>
...
80106b80:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106b81:	e9 2a db ff ff       	jmp    801046b0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106b89:	68 f1 7a 10 80       	push   $0x80107af1
...
80106c11:	e8 2a ad ff ff       	call   80101940 <readi>
...
80106c3d:	68 0b 7b 10 80       	push   $0x80107b0b
...
80106c4a:	68 ac 7b 10 80       	push   $0x80107bac
...
80106ca3:	e8 58 d9 ff ff       	call   80104600 <memset>
...
80106cd1:	76 7d                	jbe    80106d50 <allocuvm+0xf0>
    mem = kalloc();
80106cd3:	e8 a8 b7 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106ce1:	68 29 7b 10 80       	push   $0x80107b29
...
80106d13:	68 41 7b 10 80       	push   $0x80107b41
...
80106d36:	e8 95 b5 ff ff       	call   801022d0 <kfree>
      return 0;
...
80106dde:	e8 ed b4 ff ff       	call   801022d0 <kfree>
...
80106df3:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106df4:	e9 d7 b4 ff ff       	jmp    801022d0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106dfc:	68 5d 7b 10 80       	push   $0x80107b5d
...
80106e15:	e8 66 b6 ff ff       	call   80102480 <kalloc>
...
80106ecf:	68 6e 7b 10 80       	push   $0x80107b6e
...
80106ef3:	0f 84 c5 00 00 00    	je     80106fbe <copyuvm+0xde>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106f45:	78 69                	js     80106fb0 <copyuvm+0xd0>
  uint pa, i, flags;
  char *mem;
...
80106f60:	74 6d                	je     80106fcf <copyuvm+0xef>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106f62:	8b 00                	mov    (%eax),%eax
80106f64:	a8 01                	test   $0x1,%al
80106f66:	74 5a                	je     80106fc2 <copyuvm+0xe2>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
...
80106f75:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106f78:	e8 03 b5 ff ff       	call   80102480 <kalloc>
...
80106fb4:	e8 17 b3 ff ff       	call   801022d0 <kfree>
      goto bad;
80106fb9:	83 c4 10             	add    $0x10,%esp
80106fbc:	eb c5                	jmp    80106f83 <copyuvm+0xa3>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
...
80106fc0:	eb d1                	jmp    80106f93 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106fc5:	68 92 7b 10 80       	push   $0x80107b92
80106fca:	e8 a1 93 ff ff       	call   80100370 <panic>
...
80106fd2:	68 78 7b 10 80       	push   $0x80107b78
...
80106fee:	e8 4d f7 ff ff       	call   80106740 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010705f:	e8 4c d6 ff ff       	call   801046b0 <memmove>
    len -= n;
    buf += n;
